# 💫 About Me:
<br>Greetings! 👋 I am Nagadastagiri S., a dedicated software developer with a strong focus on the dynamic field of banking technology.<br><br>🚀 Current Focus:<br>Enhancing cloud-based solutions and leading the implementation of microservices.<br><br>💡 Happy to discuss anything related to:<br>Java, Spring Boot, JavaScript, Oracle DB,Openshift Redhat Console<br><br>💼 At the moment, I'm applying my skills and knowledge in a product-based company, serving as a Software Developer. 💻<br><br>
#  Professional Background 
<br> With 3.11+ years of practical experience under my belt, I've been actively shaping cutting-edge solutions within the dynamic realm of banking. As a software developer, my journey has been a dive into the complexities of financial systems, enabling me to contribute significantly to the evolution of secure and inventive software.<br><br>
# What I Do
